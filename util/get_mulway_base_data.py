...
from MVPNet.util.util import get_train_val_set, check_makedirs
...
# get data_list
fss_list_root = root_path + '/MVPNet/lists/{}/fss_list/{}/'.format(args.data_set, args.mode)
