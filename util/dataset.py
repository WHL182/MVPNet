...
from MVPNet.util.get_weak_anns import transform_anns
...
class GSemData(Dataset):
    ...
    def __getitem__(self, index):
        ...
        # Return
        if self.mode == 'val':
            return image, label_t, s_x, s_y, subcls_list, raw_label_t,image_path, label_path, support_image_path_list, support_label_path_list
        elif self.mode == 'demo':
            total_image_list = support_image_list_ori.copy()
            total_image_list.append(raw_image)            
