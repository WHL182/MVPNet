...
from MVPNet.util.get_weak_anns import find_bbox
...
def get_save_path(args):
    ...
    args.snapshot_path = 'MVPNet_save/{}/{}/split{}/{}/snapshot'.format(args.data_set, "MVPNet_eval", args.split, backbone_str)
    args.result_path = 'MVPNet_save/{}/{}/split{}/{}/result'.format(args.data_set, "MVPNet_eval", args.split, backbone_str)
